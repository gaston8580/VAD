...
class BEVFormerEncoder(TransformerLayerSequence):
    ...
    def get_reference_points(H, W, Z=8, num_points_in_pillar=4, dim='3d', bs=1, device='cuda', dtype=torch.float):
        ...
        if dim == '3d':
            # TODO: zs和xs/ys的尺度不一致，zs是真实高度，xs/ys是bev的voxel尺度，20240614
    ...
    def point_sampling(self, reference_points, pc_range,  img_metas):
        ...
        # 通过深度值(z)的正负确定哪些点在摄像头前方。reference_points_cam[..., 2:3]：参考点的深度值(即相机坐标系中的 z 坐标)
        ...
        # 检查 x 坐标是否大于0/小于1，确保参考点在图像的左/右边界内; 
        # 检查 y 坐标是否大于0/小于1，确保参考点在图像的上/下边界内。
    ...
    def forward(self,
        ...
        Args:
            ...
            key & value (Tensor): Input multi-cameta features with shape (num_cam, num_value, bs, embed_dims)
...
class BEVFormerLayer(MyCustomBaseTransformerLayer):
    ...
    def forward(self,
        ...
        **kwargs contains some specific arguments of attentions.
        ...
        Args:
            query (Tensor): The input query with shape [num_queries, bs, embed_dims] if self.batch_first is False, else
            ...
            query_key_padding_mask (Tensor): ByteTensor for `query`, with shape [bs, num_queries]. Only used in 
                `self_attn` layer. Defaults to None.
